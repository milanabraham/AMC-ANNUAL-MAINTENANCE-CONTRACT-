...
function val()
{
  ...
  <body>
   ...
   <form class ="Lform" action="teacherac.php" method = "POST" autocomplete="off">
   <h1 class="login-title">TEACHER SIGNUP</h1>
   <input type="text" class="login-input" name="id" placeholder="Teacher id" autofocus ="true"/ required>
